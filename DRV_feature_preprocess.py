...
def main():
    ...
    test_list = [\
        "GCELL_x15_keccak_util_0.70_ar_0.5_rmax_7_pdn_sparse_clk_0.csv",\
        "GCELL_x15_keccak_util_0.80_ar_0.5_rmax_7_pdn_sparse_clk_0.csv",\
        "GCELL_x15_mpeg2_top_util_0.50_ar_2.0_rmax_7_pdn_sparse_clk_0.csv",\
        "GCELL_x15_mpeg2_top_util_0.90_ar_1.0_rmax_6_pdn_sparse_clk_0.csv",\
        "GCELL_x15_nova_util_0.80_ar_1.0_rmax_7_pdn_sparse_clk_0.csv",\
        "GCELL_x15_tate_pairing_util_0.70_ar_1.0_rmax_7_pdn_sparse_clk_0.csv",\
        "GCELL_x15_wb_conmax_top_util_0.80_ar_0.5_rmax_7_pdn_sparse_clk_0.csv"\
    ]
